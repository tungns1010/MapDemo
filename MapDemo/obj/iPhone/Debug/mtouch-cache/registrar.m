...
void xamarin_create_classes () {
	...
	__xamarin_class_map [18].handle = objc_getClass ("UITraitCollection");
	...
	__xamarin_class_map [25].handle = objc_getClass ("CLLocation");
	...
	__xamarin_class_map [41].handle = objc_getClass ("MKLocalSearch");
	__xamarin_class_map [42].handle = objc_getClass ("MKMapItem");
	__xamarin_class_map [43].handle = objc_getClass ("MKOverlayView");
	...
	__xamarin_class_map [53].handle = objc_getClass ("UISpringTimingParameters");
	...
	__xamarin_class_map [62].handle = objc_getClass ("MKLocalSearchRequest");
	__xamarin_class_map [63].handle = objc_getClass ("MKLocalSearchResponse");
	__xamarin_class_map [64].handle = objc_getClass ("MKOverlayRenderer");
